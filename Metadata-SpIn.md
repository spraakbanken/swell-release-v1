...
The work on this corpus was funded by *Språkbanken* and *Center for Language Technology* (CLT), both at the University of Gothenburg, Sweden, during 2012-2016. Part of the work on transcription, anonymization znd metadata harmonization was carried out later as part of the [*L2 profiles project*](https://spraakbanken.gu.se/en/projects/l2profiles) and [*SweLL infrastructure project*](https://spraakbanken.gu.se/en/projects/swell). 
